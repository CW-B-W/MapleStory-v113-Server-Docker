...
function action(mode, type, selection) {
	...
	if (cm.getJob() == 0) {
		...
		cm.sendNext("So you decided to become a #r�C받#k?");
	    } else {
	...
	cm.sendYesNo("Do you want to become a #r�C받#k?");
    } else if (status == 3) {
	if (cm.getJob() == 0) {
	...
	cm.sendNextPrev("You may be ready to take the next step as a #r빦쮒받#k, #r뺚��츐받#k or #r죩츐뷻#k.")
    } else if (status == 12) {
